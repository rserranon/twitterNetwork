#########################################################################################
#   Modified version of twitterMap by Roberto Serrano from: 
...
twitterMap <- function(userName,userLocation=NULL,fileName=paste("twitterMap_",userName,".pdf"),nMax = 1000,plotType=c("followers","both","following")){
